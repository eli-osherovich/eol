function t = Armijo_backtracking(x0, Ax0, val0, grad0, ...
        FuncAxStruct, funcX, Adir, dir, options)
...
for i = 1:maxIter
    ...
    %[val, grad] = calc_EDx(x, Ax, FuncAxStruct, funcX, Adir, dir);
    val = calc_EDx(x, Ax, FuncAxStruct, funcX, [], []);
    
    val0eps = eps*val0;
    
    if val > val0 + alpha*t*grad0 - val0eps - eps*val
        [val, grad] = calc_EDx(x, Ax, FuncAxStruct, funcX, Adir, dir, true);
